...
import com.xun.eyepetizerkotlin.model.bean.VideoBean
import com.xun.eyepetizerkotlin.utils.*
...
/**
 * Created by wangxun on 2019/2/13.
 */
class VideoDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bean = intent?.getParcelableExtra("data") as VideoBean
        initView()
        prepareVideo()
    }
    ...
    class ImageViewAsyncTask(handler: Handler, activity: VideoDetailActivity, private val mImageView: ImageView) : AsyncTask<String, Void, String>() {
